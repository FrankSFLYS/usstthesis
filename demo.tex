...
\input{elements/chapter1.tex} % 论文的内容要求
% 也可以直接在此文件中编写，但是比较乱
\chapter{论文的格式要求}
...
\lstinputlisting[caption=code.c]{code/code.c}
...
\input{elements/chapter2.tex} % 论文的格式要求
\input{elements/chapter3.tex} % 论文的写作细则
% 表格、插图等内容在 elements/chapter3.tex 中有所体现

\backmatter % 结尾内容

\input{elements/citation.tex}
